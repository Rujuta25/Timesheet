...
function addTimesheet(intent, session, callback) {
    ...
    if (projectSlot && typeof(projectSlot.value) !== 'undefined') {
        ...
        speechOutput = categorySlot && typeof(categorySlot.value) !== 'undefined' ? `Rujuta. Adding new timesheet to ${project} project, ${category} category.` : `Rujuta. Adding new timesheet to ${project} project.`;
    } else {
